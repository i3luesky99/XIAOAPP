        ...
        <ImageBackground source={BGimg} style={styles.backgroundContainer}>
            ...
            <View>
                ...
                <View>
                    ...
                    />
                    <Feather name={'lock'} size={23} style={styles.input_icon} />
                    <TouchableWithoutFeedback
                        onPress={updateSecureTextEntry}>
                        {data.secureTextEntry ?
                            <Icon name='eye' size={23} style={styles.btn_icon} />
                            :
                            <Icon name='eye-off' size={23} style={styles.btn_icon} />
                        }
                    </TouchableWithoutFeedback>
                </View>
                <TouchableOpacity style={styles.btn_login}>
                    ...
                    style={styles.text_regis}>Đăng ký ngay</Text>
                <Text style={styles.text_1}>Bạn chưa có tài khoản?</Text>
            </View>
        </ImageBackground>
    );
};
